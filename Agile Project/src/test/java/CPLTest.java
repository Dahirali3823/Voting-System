...
public class CPLTest {
    ...
    void testCalculateSeatDistribution() {
        ...
        CPLClass.ElectionData data = new CPLClass.ElectionData("CPL", partyVotes.keySet().stream().toList(), totalSeats,
                10000, new ArrayList<>());
    ...
    void testBreakTiesRandomlySingleParty() {
        ...
        assertEquals(tiedParties, sortedTiedParties, "The sorted tied parties list should be equal to the input tied parties list");
    }
    @Test
    void testBreakTiesRandomlyRandomness() {
        ...
        assertTrue(pValue >= significanceLevel, "The p-value should be greater than or equal to the significance level");
    }
